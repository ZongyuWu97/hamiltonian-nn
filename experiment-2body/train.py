...
def get_args():
    ...
    parser.add_argument(
        "--input_dim", default=2 * 4, type=int, help="dimensionality of input tensor"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--input_noise", default=0.0, type=int, help="std of noise added to inputs"
    )
    parser.add_argument(
        "--nonlinearity", default="tanh", type=str, help="neural net nonlinearity"
    )
    parser.add_argument(
        "--total_steps", default=10000, type=int, help="number of gradient steps"
    )
    parser.add_argument(
        "--print_every",
        default=200,
    ...
    parser.add_argument(
        "--name", default="2body", type=str, help="only one option right now"
    )
    parser.add_argument(
        "--baseline",
        dest="baseline",
...
def train(args):
    ...
    for step in range(args.total_steps + 1):
        ...
        if args.verbose and step % args.print_every == 0:
            print(
                "step {}, train_loss {:.4e}, test_loss {:.4e}, grad norm {:.4e}, grad std {:.4e}".format(
